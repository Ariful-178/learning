...
test.describe('use the same authentication mechanism',async()=>{
    ...
    test("006MangeEventPage_Event_Details_001 | Clicking Manage event ", async ({AttendeeInformationPage,ManageEventPage,Design, EventdashboardPage, page,ReservationPage,AppsPage,AccountManagement }) => {
        ...
        // //     await AppsPage.type_search_in_field('2023 Coachella Festival Store')
        // //     await AppsPage.type_search_in_field('2023 Coachella Festival Store')
        //     await ManageEventPage.click_app_name_2023_coachella()
        // // })
        await test.step('click_3rd_app_name_2023_coachella', async() =>{ 
            await AppsPage.type_search_in_field('2023 Coachella Festival Store')
            await ManageEventPage.click_app_name_2023_coachella()
    ...
    test("006MangeEventPage_Event_Settings_020 | clear and type Event banner text ", async ({AttendeeInformationPage,ManageEventPage,Design, EventdashboardPage, page,ReservationPage,AppsPage,AccountManagement }) => {
